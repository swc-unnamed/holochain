-- CreateEnum
CREATE TYPE "lot_type" AS ENUM ('LOT', 'TEMPLATE');

-- CreateEnum
CREATE TYPE "lot_status" AS ENUM ('DRAFT', 'COMPLETED', 'LISTED', 'SCHEDULED', 'SOLD', 'WITHDRAWN');

-- CreateEnum
CREATE TYPE "auction_type" AS ENUM ('LIVE', 'SEALED', 'TIMED');
...
CREATE TABLE "auctions" (
    ...
    "type" "auction_type" NOT NULL DEFAULT 'SEALED',
...
CREATE TABLE "lots" (
    ...
    "auction_id" TEXT,
    "type" "lot_type" NOT NULL DEFAULT 'LOT',
    "title" TEXT NOT NULL,
